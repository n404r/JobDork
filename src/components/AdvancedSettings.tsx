      ...
      <div className="bg-[#0a0f1a] border border-white/5 rounded-xl p-3.5 sm:p-5 shadow-xl">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-300">Included Sources</h3>
            <div className="flex items-center gap-1.5 text-[0.625rem] font-medium">
          ...
          {SOURCES.length > DISPLAY_LIMIT && (
            <button 
              ...
              className="mt-2 w-full flex items-center justify-center gap-1.5 py-1.5 rounded-lg border border-white/5 bg-[#121826] text-[0.625rem] font-semibold text-gray-400 hover:text-white hover:bg-white/5 transition-all"
            >
        ...
        <div className="border-t border-white/5 pt-4">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-sm font-semibold text-gray-300">Excluded Job Boards</h3>
            <div className="flex items-center gap-1.5 text-[0.625rem] font-medium">
        ...
        {/* Additional Filters */}
        <div className="border-t border-white/5 pt-4">
          <h3 className="text-sm font-semibold text-gray-300 mb-3">Additional Filters</h3>
          ...
          <div className="grid grid-cols-2 gap-4 mt-4">
            <div>
              <label className="block text-xs font-semibold text-gray-400 mb-1.5">Date Filter</label>
              <select
                value={state.dateFilter}
                onChange={(e) => updateState({ dateFilter: e.target.value as any })}
                className={`w-full px-3 py-2 rounded-lg border bg-[#121826] text-sm font-medium outline-none appearance-none transition-colors
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-400 mb-1.5">Custom Filter</label>
              <input
                type="text"
                value={state.customFilter}
                onChange={(e) => updateState({ customFilter: e.target.value })}
                placeholder='e.g. "we are hiring"'
                className={`w-full px-3 py-2 rounded-lg border bg-[#121826] text-sm font-medium outline-none transition-colors
